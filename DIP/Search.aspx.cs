...
namespace BoxInformation
{
    ...
    public partial class Search : Page, ISearchView
    {
        ...
        public string ClientNumber
        {
            get
            {
                if (txtClientNumber != null && txtClientNumber.Text.Length > 0)
                {
        ...
        public string ClientName
        {
            get
            {
                if (txtClientName !=null && txtClientName.Text.Length > 0)
                {
        ...
        public string ClientPrincipal
        {
            get
            {
                if (txtClientContact != null && txtClientContact.Text.Length > 0)
                {
